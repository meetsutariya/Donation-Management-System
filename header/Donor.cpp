...
void Donor ::DataBase()
{
     Insert("Arnish Satasiya", 6354154601, 45, 0);
     money += 1500000;
     Insert("Jay Kuvadiya", 7801902490, 40, 0);
     money += 1500000;
     Insert("Meet Sutariya", 9979459397, 50, 0);
     money += 1000000;
     Insert("Deep Kanani", 9327915430, 35, 0);
     money += 1000000;
}
...
void Donor::blood_donated(int ch)
{
     ...
     int b_d;
     cout << "How much Blood (in ml) that You have Donated : ";
     cin >> b_d;
     balance[ch] += b_d;
     cout << "---------------------------------------------------------------" << endl;
